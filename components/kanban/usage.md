...
<x-demo class="flex justify-center">
    <x-ui.kanban>
        <x-ui.kanban.column
            id="axioms" 
            title="Axioms"
            description="Foundational statements"
            :count="6"
        >
        ...
        <x-ui.kanban.column id="theorems" title="Proven Theorems" :count="4">
...
<x-demo class="flex justify-center">
    <x-ui.kanban class="[--column-width:18rem]">
        <x-ui.kanban.column title="Conjectures" :count="4">
            <x-ui.kanban.card>
        ...
        <x-ui.kanban.column title="Proof Techniques" :count="5">
            <x-ui.kanban.card>
...
<x-demo class="flex justify-center">
    <x-ui.kanban>
        <x-ui.kanban.column title="Complexity Classes" :count="5">
            <x-ui.kanban.card>
                <x-slot:top>
...
<x-demo class="flex justify-center">
    <x-ui.kanban>
        <x-ui.kanban.column title="Proof Steps" :count="6">
            <x-ui.kanban.card>
                <x-slot:handle>
...
<x-demo class="flex justify-center">
    <x-ui.kanban>
        <x-ui.kanban.column title="Extra Small" size="xs" :count="3">
            <x-ui.kanban.card>
        ...
        <x-ui.kanban.column title="Small" size="sm" :count="3">
            <x-ui.kanban.card>
        ...
        <x-ui.kanban.column title="Medium (Default)" size="md" :count="3">
            <x-ui.kanban.card>
...
```blade
<!-- Extra small cards -->
<x-ui.kanban.column title="Tasks" size="xs">
    <x-ui.kanban.card>
...
<!-- Small cards -->
<x-ui.kanban.column title="Tasks" size="sm">
    <x-ui.kanban.card>
...
<x-ui.kanban.column title="Tasks">
    <x-ui.kanban.card>
        <h4>Medium card</h4>
    </x-ui.kanban.card>
</x-ui.kanban.column>
...
```blade
<x-ui.kanban.column title="Column Name">
    <x-slot:empty>
...
<x-demo class="flex justify-center">
    <x-ui.kanban>
        <x-ui.kanban.column title="Open Problems" :count="6">
            <x-ui.kanban.card>
...
<x-demo class="flex justify-center">
    <x-ui.kanban class="[--column-width:24rem]">
        ...
        <x-ui.kanban.column
            id="conjectures"
            title="Conjectures"
            description="Unproven statements"
            :count="4"
        >
            <x-ui.kanban.card>
                <x-slot:top>
        ...
        <x-ui.kanban.column id="proven" title="Proven Theorems" :count="0">
            <x-slot:empty>
...
| `description` | string | `null` | Column description (displayed below title) |
...
The kanban component consists of three parts:

**Board** (`<x-ui.kanban>`) - Container that manages the horizontal scrolling layout and column sizing

**Column** (`<x-ui.kanban.column>`) - Vertical container for cards with optional header, footer, and empty states
